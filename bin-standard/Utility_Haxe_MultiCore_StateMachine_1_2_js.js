...
org.puremvc.haxe.utilities.statemachine.StateMachine.prototype.transitionTo = function(nextState,data) {
...
org.puremvc.haxe.utilities.statemachine.State = function(name,entering,exiting,changed) { if( name === $_ ) return; {
	this.name = name;
...
org.puremvc.haxe.utilities.statemachine.State.prototype.changed = null;
...
org.puremvc.haxe.utilities.statemachine.FSMInjector.prototype.createState = function(stateDef) {
	...
	var state = new org.puremvc.haxe.utilities.statemachine.State(name,entering,exiting,changed);
